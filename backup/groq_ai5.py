...
async def get_song_analysis_details_groq(sp_client: spotipy.Spotify, song_uri: str) -> dict:
    ...
    if analysis_data and 'Details' in analysis_data:
        # Ensure frontend-friendly key exists
        if isinstance(analysis_data, dict):
            analysis_data.setdefault('details', analysis_data.get('Details'))
            analysis_data.setdefault('groq_analysis', analysis_data.get('Details'))
